...
from llm_hallucinations.pipeline import run_rag_experiment


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the RAG medical QA prototype.")
...
def main() -> None:
    ...
    df, output_path = run_rag_experiment(config, top_k=args.top_k)
